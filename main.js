...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./task.js */ \"./src/task.js\");\n/* harmony import */ var _dom_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom.js */ \"./src/dom.js\");\n\r\n\r\n\r\nclass Project {\r\n  static myProjects = {};\r\n  static idCount = 1;\r\n  static activeProject = 0;\r\n  constructor(projectName) {\r\n    this.projectName = projectName;\r\n    this.taskList = [];\r\n  }\r\n  addTask(task) {\r\n    this.taskList.push(task);\r\n  }\r\n  static deleteProject(id) {\r\n    delete Project.myProjects[id];\r\n    _dom_js__WEBPACK_IMPORTED_MODULE_1__.default.refreshList();\r\n  }\r\n  static newProject(e, name) {\r\n    if (name === undefined) name = _dom_js__WEBPACK_IMPORTED_MODULE_1__.default.projectAddNameIn.value;\r\n    const project = new Project(name);\r\n    const date = Date.now();\r\n    const defaultTask = new _task_js__WEBPACK_IMPORTED_MODULE_0__.default(\r\n      date,\r\n      \"Example Task\",\r\n      \"This is a description of your upcoming task.\",\r\n      0\r\n    );\r\n    project.addTask(defaultTask);\r\n    Project.myProjects[Project.idCount] = project;\r\n    _dom_js__WEBPACK_IMPORTED_MODULE_1__.default.appendProject(Project.idCount);\r\n    _dom_js__WEBPACK_IMPORTED_MODULE_1__.default.projectFormVisibility();\r\n    Project.idCount++;\r\n  }\r\n  static swapProject(e) {\r\n    e.preventDefault();\r\n    Project.activeProject = this.dataset.project;\r\n    _dom_js__WEBPACK_IMPORTED_MODULE_1__.default.displayProjectContents(this.dataset.project);\r\n  }\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Project);\r\n\n\n//# sourceURL=webpack://organize-self/./src/Project.js?");
